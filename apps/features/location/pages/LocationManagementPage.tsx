  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
        <div>
          <div style={{ fontSize: 15, fontWeight: 900, color: '#0C4A6E', display: 'flex', alignItems: 'center', gap: 8 }}>
            <span>📍</span> {title}
          </div>
            ...
            {(['VECTOR', 'SATELLITE', 'HYBRID'] as const).map((thm) => (
              <button
                ...
                style={{
                  ...
                  fontWeight: 800,
                  cursor: 'pointer',
                  backgroundColor: mapTheme === thm ? '#0284C7' : 'transparent',
      ...
      <div
        ...
        style={{
          ...
          overflow: 'hidden',
          cursor: 'crosshair',
          backgroundColor: mapTheme === 'SATELLITE' ? '#082F49' : mapTheme === 'HYBRID' ? '#0C4A6E' : '#F0F9FF',
          backgroundImage:
            mapTheme === 'VECTOR'
              ? 'radial-gradient(#BAE6FD 1px, transparent 1px)'
              : 'radial-gradient(rgba(56, 189, 248, 0.2) 1px, transparent 1px)',
          backgroundSize: '24px 24px',
          boxShadow: 'inset 0 2px 8px rgba(2, 132, 199, 0.05)',
        }}
      >
        {/* Map Watermark & Scale */}
        <div style={{ position: 'absolute', top: 12, left: 12, zIndex: 5, backgroundColor: 'rgba(12, 74, 110, 0.9)', color: '#FFFFFF', padding: '6px 12px', borderRadius: 6, fontSize: 11, fontWeight: 700, backdropFilter: 'blur(4px)', border: '1px solid #0284C7' }}>
           Center: {centerLat.toFixed(4)}, {centerLng.toFixed(4)} (Scale: {radiusKm} KM Circle)
        </div>

        <div style={{ position: 'absolute', bottom: 12, right: 12, zIndex: 5, backgroundColor: '#FFFFFF', color: '#0C4A6E', padding: '4px 10px', borderRadius: 6, fontSize: 10, fontWeight: 800, border: '1px solid #BAE6FD', boxShadow: '0 2px 6px rgba(2, 132, 199, 0.15)' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
          <span style={{ fontSize: 12, fontWeight: 800, color: '#0C4A6E' }}>Quick Pin Presets:</span>
        ...
        <form onSubmit={handleManualAdd} style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
          <input
            ...
            style={{ width: 100, padding: '6px 8px', borderRadius: 6, border: '1px solid #BAE6FD', fontSize: 12, backgroundColor: '#FFFFFF', color: '#0C4A6E' }}
          />
          <input
            type="number"
            step="0.0001"
      ...
      {currentPins.length > 0 ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 10 }}>
            {currentPins.map((pin, idx) => (
              <div
                ...
                onMouseLeave={() => setHoveredPinIndex(null)}
                style={{
                  backgroundColor: hoveredPinIndex === idx ? '#E0F2FE' : '#FFFFFF',
                  padding: '10px 12px',
                  borderRadius: 8,
              ...
              >
                <div>
                  <div style={{ fontWeight: 800, color: '#0C4A6E' }}>
                    📍 Pin #{idx + 1}
                  </div>
                  <div style={{ color: '#0369A1', fontSize: 11, fontFamily: 'monospace', marginTop: 2 }}>
        ...
        <div style={{ textAlign: 'center', padding: 16, backgroundColor: '#F0F9FF', borderRadius: 8, border: '1px dashed #BAE6FD', fontSize: 12, color: '#0369A1' }}>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
              ...
              >
                <div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: '#0C4A6E' }}> Restaurant Onboarding</div>
                  <div style={{ fontSize: 11, color: '#0369A1' }}>Allow restaurants to register & accept orders</div>
                </div>
                <input
                  type="checkbox"
              ...
              >
                <div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: '#0C4A6E' }}> Delivery Partner Dispatch</div>
                  <div style={{ fontSize: 11, color: '#0369A1' }}>Allow driver fleet dispatch & payouts</div>
                </div>
                <input
                  type="checkbox"
              ...
              >
                <div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: '#0C4A6E' }}> Customer Ordering Power</div>
                  <div style={{ fontSize: 11, color: '#0369A1' }}>Allow customers to place food orders</div>
                </div>
                <input
                  type="checkbox"
      ...
      {activeTab === 'DELIVERY_ZONES' && (
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, border: '1px solid #BAE6FD', boxShadow: '0 4px 14px rgba(2, 132, 199, 0.04)', overflow: 'hidden' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13 }}>
            ...
            <tbody>
              {deliveryZones.map((dz) => (
                <tr key={dz.id} style={{ borderBottom: '1px solid #F0F9FF' }}>
                  <td style={{ padding: '16px 20px' }}>
                    <div style={{ fontWeight: 800, color: '#0C4A6E' }}>{dz.zoneName}</div>
                    <div style={{ fontSize: 11, color: '#0369A1', marginTop: 2 }}>
                       Lat: {dz.latitude}, Lng: {dz.longitude}
                    </div>
                  </td>

                  <td style={{ padding: '16px 20px', color: '#0369A1' }}>{dz.cityName}</td>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          backgroundColor: dz.restaurantEnabled ? '#0284C7' : '#F0F9FF',
                          color: dz.restaurantEnabled ? '#FFFFFF' : '#0369A1',
                          boxShadow: dz.restaurantEnabled ? '0 2px 6px rgba(2, 132, 199, 0.25)' : 'none',
                          fontSize: 11,
                          fontWeight: 800,
                          cursor: 'pointer',
                          transition: 'all 0.15s ease',
                      ...
                      <button
                        ...
                        style={{
                          ...
                          backgroundColor: dz.deliveryPartnerEnabled ? '#0284C7' : '#F0F9FF',
                          color: dz.deliveryPartnerEnabled ? '#FFFFFF' : '#0369A1',
                          boxShadow: dz.deliveryPartnerEnabled ? '0 2px 6px rgba(2, 132, 199, 0.25)' : 'none',
                          fontSize: 11,
                          fontWeight: 800,
                          cursor: 'pointer',
                          transition: 'all 0.15s ease',
                      ...
                      <button
                        ...
                        style={{
                          ...
                          backgroundColor: dz.customerOrderingEnabled ? '#0284C7' : '#F0F9FF',
                          color: dz.customerOrderingEnabled ? '#FFFFFF' : '#0369A1',
                          boxShadow: dz.customerOrderingEnabled ? '0 2px 6px rgba(2, 132, 199, 0.25)' : 'none',
                          fontSize: 11,
                          fontWeight: 800,
                          cursor: 'pointer',
                          transition: 'all 0.15s ease',
      ...
      {editingZoneMap && (
        <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(12, 74, 110, 0.45)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, padding: 20 }}>
          <div style={{ backgroundColor: '#FFFFFF', borderRadius: 16, maxWidth: 900, width: '100%', maxHeight: '90vh', overflowY: 'auto', padding: 24, display: 'flex', flexDirection: 'column', gap: 16, border: '1px solid #BAE6FD', boxShadow: '0 12px 36px rgba(2, 132, 199, 0.2)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 8 }}>
              <button
                ...
                style={{ padding: '10px 20px', backgroundColor: '#0284C7', color: '#FFFFFF', border: 'none', borderRadius: 8, fontWeight: 800, cursor: 'pointer', boxShadow: '0 4px 12px rgba(2, 132, 199, 0.25)' }}
              >
                Save Map Pins & Close
              </button>
            </div>
      ...
      {activeTab === 'UNSERVICEABLE_REQUESTS' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div style={{ backgroundColor: '#F0F9FF', border: '1px solid #BAE6FD', padding: 16, borderRadius: 12, color: '#0C4A6E', fontSize: 13, fontWeight: 700 }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13 }}>
              ...
              <tbody>
                {unserviceableRequests.map((req) => (
                  <tr key={req.id} style={{ borderBottom: '1px solid #F0F9FF' }}>
                    <td style={{ padding: '16px 20px' }}>
                      <div style={{ fontWeight: 800, color: '#0C4A6E' }}>{req.restaurantName}</div>
                      <div style={{ fontSize: 11, color: '#0369A1' }}>{req.address}, {req.cityName}</div>
                    </td>
                    <td style={{ padding: '16px 20px' }}>
                      <div style={{ fontWeight: 700, color: '#0C4A6E' }}>{req.contactPerson}</div>
                      <div style={{ fontSize: 11, color: '#0369A1' }}>{req.contactPhone}</div>
                    </td>
                    <td style={{ padding: '16px 20px', fontWeight: 700, color: '#0C4A6E' }}>
                       Lat: {req.latitude}, Lng: {req.longitude}
                    </td>
                    <td style={{ padding: '16px 20px', color: '#0369A1', fontSize: 12 }}>
                      {req.createdAt}
                    </td>
                    <td style={{ padding: '16px 20px' }}>
                      <span
                    ...
                    <td style={{ padding: '16px 20px' }}>
                      {req.status === 'PENDING' ? (
                        ...
                        <span style={{ fontSize: 12, color: '#0369A1', fontWeight: 700 }}>Resolved</span>
                      )}
                    </td>
                  </tr>
                ))}
      ...
      {showRequestModal && (
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            <div>
              ...
              <input
                ...
                style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }}
                required
              />
            </div>
            <div>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 12, marginTop: 10 }}>
            ...
            <button
              type="submit"
              style={{ padding: '10px 24px', backgroundColor: '#0284C7', color: '#FFFFFF', border: 'none', borderRadius: 8, fontWeight: 800, cursor: 'pointer', boxShadow: '0 4px 12px rgba(2, 132, 199, 0.25)' }}
            >
      ...
      {activeTab === 'CITIES' && (
        <div style={{ display: 'grid', gridTemplateColumns: '360px 1fr', gap: 24 }}>
          ...
          >
            <h3 style={{ fontSize: 16, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>Add Operating City</h3>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>City Name</label>
              <input type="text" placeholder="e.g. Pune" value={newCityName} onChange={(e) => setNewCityName(e.target.value)} style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>State / Region</label>
              <input type="text" placeholder="e.g. Maharashtra" value={newState} onChange={(e) => setNewState(e.target.value)} style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <button type="submit" style={{ padding: '12px', backgroundColor: '#0284C7', color: '#FFFFFF', border: 'none', borderRadius: 8, fontWeight: 800, fontSize: 13, cursor: 'pointer', marginTop: 8, boxShadow: '0 4px 12px rgba(2, 132, 199, 0.25)' }}>
              Add City
            </button>
          </form>
              ...
              <tbody>
                {cities.map((c) => (
                  <tr key={c.id} style={{ borderBottom: '1px solid #F0F9FF' }}>
                    <td style={{ padding: '16px 20px' }}>
                      <div style={{ fontWeight: 800, color: '#0C4A6E' }}>{c.cityName}</div>
                      <div style={{ fontSize: 11, color: '#0369A1' }}>{c.state}</div>
                    </td>
                    <td style={{ padding: '16px 20px', fontWeight: 700, color: '#0C4A6E' }}>{c.activeZonesCount} Zones</td>
                    <td style={{ padding: '16px 20px', fontWeight: 700, color: '#0C4A6E' }}>{c.activeMerchantsCount} Outlets</td>
                    <td style={{ padding: '16px 20px' }}>
                      <span style={{ fontSize: 11, fontWeight: 800, backgroundColor: '#E0F2FE', color: '#0284C7', border: '1px solid #BAE6FD', padding: '3px 8px', borderRadius: 4 }}>
                        {c.status}
                      </span>
                    </td>
                  </tr>
      ...
      {activeTab === 'SERVICE_AREAS' && (
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, border: '1px solid #BAE6FD', boxShadow: '0 4px 14px rgba(2, 132, 199, 0.04)', overflow: 'hidden' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13 }}>
            ...
            <tbody>
              {serviceAreas.map((sa) => (
                <tr key={sa.id} style={{ borderBottom: '1px solid #F0F9FF' }}>
                  <td style={{ padding: '16px 20px' }}>
                    <div style={{ fontWeight: 800, color: '#0C4A6E' }}>{sa.areaName}</div>
                    <div style={{ fontSize: 11, color: '#0369A1' }}>{sa.cityName}</div>
                  </td>
                  <td style={{ padding: '16px 20px', fontWeight: 700, color: '#0C4A6E' }}>{sa.pincode}</td>
                  <td style={{ padding: '16px 20px' }}>
                    <span style={{ fontSize: 11, fontWeight: 800, backgroundColor: '#E0F2FE', color: '#0284C7', border: '1px solid #BAE6FD', padding: '3px 8px', borderRadius: 4 }}>
                      {sa.coverageStatus.replace('_', ' ')}
                    </span>
                  </td>
                  <td style={{ padding: '16px 20px', fontWeight: 700, color: '#0C4A6E' }}>{sa.totalOutlets} Outlets</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {activeTab === 'DELIVERY_CHARGES' && (
        <form
          ...
          style={{ backgroundColor: '#FFFFFF', borderRadius: 14, padding: 28, border: '1px solid #BAE6FD', boxShadow: '0 4px 14px rgba(2, 132, 199, 0.04)', display: 'flex', flexDirection: 'column', gap: 20 }}
        >
          <h3 style={{ fontSize: 18, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>Distance-Based Delivery Charge Matrix</h3>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Base Delivery Fee (₹)</label>
              <input type="number" value={baseCharge} onChange={(e) => setBaseCharge(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Base Distance Coverage (KM)</label>
              <input type="number" value={baseDistanceKm} onChange={(e) => setBaseDistanceKm(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Additional Fee per KM (₹)</label>
              <input type="number" value={additionalChargePerKm} onChange={(e) => setAdditionalChargePerKm(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Free Delivery Order Threshold (₹)</label>
              <input type="number" value={freeDeliveryMinOrder} onChange={(e) => setFreeDeliveryMinOrder(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Night Dispatch Surcharge (₹)</label>
              <input type="number" value={nightSurcharge} onChange={(e) => setNightSurcharge(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Peak Surge Multiplier</label>
              <input type="number" step="0.05" value={surgeMultiplier} onChange={(e) => setSurgeMultiplier(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
          </div>
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 10 }}>
            <button type="submit" style={{ padding: '12px 24px', backgroundColor: '#0284C7', color: '#FFFFFF', border: 'none', borderRadius: 8, fontWeight: 800, fontSize: 14, cursor: 'pointer', boxShadow: '0 4px 12px rgba(2, 132, 199, 0.25)' }}>
      ...
      {activeTab === 'RADIUS_SETTINGS' && (
        <form
          ...
          style={{ backgroundColor: '#FFFFFF', borderRadius: 14, padding: 28, border: '1px solid #BAE6FD', boxShadow: '0 4px 14px rgba(2, 132, 199, 0.04)', display: 'flex', flexDirection: 'column', gap: 20 }}
        >
          <h3 style={{ fontSize: 18, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>Operational Radius & Dispatch Parameters</h3>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Maximum Operating Delivery Radius (KM)</label>
              <input type="number" value={maxDeliveryRadius} onChange={(e) => setMaxDeliveryRadius(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Customer Restaurant Discovery Radius (KM)</label>
              <input type="number" value={customerSearchRadius} onChange={(e) => setCustomerSearchRadius(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Driver Auto-Dispatch Broadcast Radius (KM)</label>
              <input type="number" value={driverDispatchRadius} onChange={(e) => setDriverDispatchRadius(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Distance Calculation Engine Mode</label>
              <select value={distanceCalculationMode} onChange={(e) => setDistanceCalculationMode(e.target.value as 'GPS_ROAD' | 'HAVERSINE')} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, backgroundColor: '#FFFFFF', color: '#0C4A6E' }}>
