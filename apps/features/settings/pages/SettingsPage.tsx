  ...
  return (
    <div style={{ maxWidth: 1180, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
        <div>
          <h1 style={{ fontSize: 24, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>
            Control Center Settings
          </h1>
          <p style={{ fontSize: 14, color: '#0369A1', margin: '4px 0 0 0' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', gap: 24 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {activeTab === 'admin-profile' && (
            <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, padding: 28, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 20 }}>
              <h3 style={{ fontSize: 18, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>
                Personal Admin Profile
              </h3>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Full Name</label>
                  <input type="text" value={profileName} onChange={(e) => setProfileName(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Email Address</label>
                  <input type="email" value={profileEmail} onChange={(e) => setProfileEmail(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Contact Phone</label>
                  <input type="text" value={profilePhone} onChange={(e) => setProfilePhone(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Assigned System Role</label>
                  <input type="text" value="SUPER_ADMIN (Full Control)" readOnly style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', backgroundColor: '#F0F9FF', color: '#0C4A6E', fontWeight: 700, fontSize: 13 }} />
                </div>
              </div>

              <div style={{ borderTop: '1px solid #BAE6FD', paddingTop: 20, marginTop: 10 }}>
                <h4 style={{ fontSize: 15, fontWeight: 700, color: '#0C4A6E', margin: '0 0 14px 0' }}>Password & Security Credentials</h4>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 14 }}>
                  <div>
                    <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0369A1', marginBottom: 6 }}>Current Password</label>
                    <input type="password" placeholder="••••••••" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} style={{ width: '100%', padding: '9px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                  </div>
                  <div>
                    <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0369A1', marginBottom: 6 }}>New Password</label>
                    <input type="password" placeholder="••••••••" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} style={{ width: '100%', padding: '9px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                  </div>
                  <div>
                    <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0369A1', marginBottom: 6 }}>Confirm New Password</label>
                    <input type="password" placeholder="••••••••" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} style={{ width: '100%', padding: '9px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                  </div>
                </div>
              </div>
            </div>
              ...
              {selectedPolicy && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16, borderTop: '1px solid #BAE6FD', paddingTop: 16 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span style={{ fontSize: 11, fontWeight: 800, backgroundColor: '#E0F2FE', color: '#0284C7', border: '1px solid #BAE6FD', padding: '3px 8px', borderRadius: 6 }}>
                      STATUS: {selectedPolicy.status} • LAST REVISION: {selectedPolicy.lastUpdated}
                    </span>
                    <span style={{ fontSize: 11, color: '#0369A1', fontFamily: 'monospace' }}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 14, fontWeight: 700, color: '#0C4A6E', backgroundColor: '#FFFFFF' }}
                    />
                  </div>
          ...
          {activeTab === 'admin-users' && (
            <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, padding: 28, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 20 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div>
                  <h3 style={{ fontSize: 18, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>Admin Console Team</h3>
                  <div style={{ fontSize: 12, color: '#0369A1', marginTop: 2 }}>Manage admin accounts, executive access levels & operational personnel</div>
                </div>
                <button type="button" onClick={() => setIsAddUserModalOpen(true)} style={{ padding: '8px 16px', backgroundColor: '#0284C7', color: '#FFFFFF', border: 'none', borderRadius: 8, fontWeight: 700, fontSize: 13, cursor: 'pointer', boxShadow: '0 2px 6px rgba(2, 132, 199, 0.25)' }}>
                  Add Admin User
                </button>
              </div>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13 }}>
                ...
                <tbody>
                  {adminUsers.map((u) => (
                    <tr key={u.id} style={{ borderBottom: '1px solid #BAE6FD' }}>
                      <td style={{ padding: '14px 16px' }}>
                        <div style={{ fontWeight: 700, color: '#0C4A6E' }}>{u.name}</div>
                        <div style={{ fontSize: 12, color: '#0369A1' }}>{u.email}</div>
                      </td>
                      <td style={{ padding: '14px 16px' }}>
                        <span style={{ fontSize: 11, fontWeight: 800, backgroundColor: '#E0F2FE', color: '#0284C7', padding: '3px 8px', borderRadius: 4, border: '1px solid #BAE6FD' }}>
                          {u.role}
                        </span>
                      </td>
                      <td style={{ padding: '14px 16px', color: '#0369A1' }}>{u.department}</td>
                      <td style={{ padding: '14px 16px' }}>
                        <span style={{ backgroundColor: '#E0F2FE', color: '#0284C7', border: '1px solid #BAE6FD', fontSize: 11, fontWeight: 700, padding: '3px 8px', borderRadius: 12 }}>
                          {u.status}
                        </span>
                      </td>
                      <td style={{ padding: '14px 16px', color: '#0369A1', fontSize: 12 }}>{u.lastLogin}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          {activeTab === 'roles-permissions' && (
            <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, padding: 28, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 20 }}>
              <div>
                <h3 style={{ fontSize: 18, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>Role-Based Access Control (RBAC)</h3>
                <div style={{ fontSize: 12, color: '#0369A1', marginTop: 2 }}>Configure permissions matrix for SUPER_ADMIN, OPS, FINANCE, and SUPPORT roles</div>
              </div>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13 }}>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={perm.key} style={{ borderBottom: '1px solid #BAE6FD' }}>
                      <td style={{ padding: '14px 16px', fontWeight: 600, color: '#0C4A6E' }}>{perm.label}</td>
          ...
          {activeTab === 'tax-gst' && (
            <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, padding: 28, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 20 }}>
              <h3 style={{ fontSize: 18, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>Tax & GST Compliance Rules</h3>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>GSTIN Number</label>
                  <input type="text" value={gstinNumber} onChange={(e) => setGstinNumber(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Food Order GST Rate (%)</label>
                  <input type="number" value={foodGstRate} onChange={(e) => setFoodGstRate(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Delivery Service GST (%)</label>
                  <input type="number" value={deliveryGstRate} onChange={(e) => setDeliveryGstRate(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>TCS Tax Rate (%)</label>
                  <input type="number" value={tcsTaxRate} onChange={(e) => setTcsTaxRate(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'payment-settings' && (
            <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, padding: 28, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 20 }}>
              <h3 style={{ fontSize: 18, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>Payment Gateways & COD Rules</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: 14, fontWeight: 700, color: '#0C4A6E' }}>Enable Razorpay Gateway (UPI, Netbanking, Cards)</span>
                </label>
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: 14, fontWeight: 700, color: '#0C4A6E' }}>Enable Stripe Gateway (International Cards)</span>
                </label>
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: 14, fontWeight: 700, color: '#0C4A6E' }}>Enable Cash on Delivery (COD)</span>
                </label>
              </div>

              <div style={{ borderTop: '1px solid #BAE6FD', paddingTop: 16, marginTop: 8 }}>
                <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Max Order Limit for Cash on Delivery (₹)</label>
                <input type="number" value={codMaxLimit} onChange={(e) => setCodMaxLimit(e.target.value)} style={{ width: '100%', maxWidth: 300, padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
              </div>
            </div>
          )}
          ...
          {activeTab === 'app-settings' && (
            <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, padding: 28, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 20 }}>
              <h3 style={{ fontSize: 18, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>Customer App & Operational Parameters</h3>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Minimum Required App Version</label>
                  <input type="text" value={minAppVersion} onChange={(e) => setMinAppVersion(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Max Operating Delivery Radius (KM)</label>
                  <input type="number" value={maxDeliveryRadius} onChange={(e) => setMaxDeliveryRadius(e.target.value)} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
                </div>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, borderTop: '1px solid #BAE6FD', paddingTop: 16 }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: 14, fontWeight: 600, color: '#0C4A6E' }}>Enforce Mandatory App Update Alert</span>
                </label>
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: 14, fontWeight: 600, color: '#0C4A6E' }}>Enable Emergency Maintenance Mode</span>
                </label>
              </div>
            </div>
          )}
          ...
          {activeTab === 'security' && (
            <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, padding: 28, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 20 }}>
              <h3 style={{ fontSize: 18, fontWeight: 800, color: '#0C4A6E', margin: 0 }}>Security, Sessions & IP Rules</h3>

              <div>
                <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>Admin Inactivity Timeout (Minutes)</label>
                <input type="number" value={sessionTimeout} onChange={(e) => setSessionTimeout(e.target.value)} style={{ width: '100%', maxWidth: 300, padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', backgroundColor: '#FFFFFF' }} />
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, paddingTop: 12, borderTop: '1px solid #BAE6FD' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                  ...
                  <div>
                    <div style={{ fontSize: 14, fontWeight: 700, color: '#0C4A6E' }}>Enforce Two-Factor Authentication (2FA)</div>
                    <div style={{ fontSize: 12, color: '#0369A1' }}>Require 2FA verification for all SUPER_ADMIN and FINANCE logins.</div>
                  </div>
                </label>
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                  ...
                  <div>
                    <div style={{ fontSize: 14, fontWeight: 700, color: '#0C4A6E' }}>Restrict Console Access to Whitelisted IP Ranges</div>
                    <div style={{ fontSize: 12, color: '#0369A1' }}>Block access from unapproved external networks.</div>
                  </div>
                </label>
              </div>
            </div>
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                style={{ width: '100%', padding: '9px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, fontFamily: 'inherit', color: '#0C4A6E', backgroundColor: '#FFFFFF' }}
              />
            </div>
