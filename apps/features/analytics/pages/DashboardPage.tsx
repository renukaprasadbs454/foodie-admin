  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
        <div>
          <div style={{ fontSize: 24, fontWeight: 800, color: '#0C4A6E', letterSpacing: '-0.5px' }}>
      ...
      {forbidden ? (
        ...
        <KpiGrid
          summary={
            query.data && (query.data.totalOrders > 0 || Number(query.data.totalRevenue) > 0)
              ? query.data
              : {
                  totalOrders: 324,
                  totalRevenue: 148500,
      ...
      <SalesAnalyticsChart range={applied} />
