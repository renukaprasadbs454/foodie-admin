  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      {toastMsg ? (
        ...
        >
          <span>{toastMsg}</span>
          <span style={{ fontSize: 12, color: '#BAE6FD' }}>● Security Directory Updated</span>
        </div>
      ) : null}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16 }}>
        <div style={{ backgroundColor: '#FFFFFF', padding: '18px 20px', borderRadius: 14, border: '1px solid #BAE6FD' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#0369A1', textTransform: 'uppercase' }}>Total Staff Members</div>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#0C4A6E', marginTop: 4 }}>{totalUsers}</div>
          <div style={{ fontSize: 12, color: '#0284C7', fontWeight: 600, marginTop: 6 }}>● Active Administrative Accounts</div>
        </div>

        <div style={{ backgroundColor: '#FFFFFF', padding: '18px 20px', borderRadius: 14, border: '1px solid #BAE6FD' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#0369A1', textTransform: 'uppercase' }}>Super Admins</div>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#0284C7', marginTop: 4 }}>{activeAdmins}</div>
          <div style={{ fontSize: 12, color: '#0369A1', fontWeight: 600, marginTop: 6 }}>Full Root System Privileges</div>
        </div>

        <div style={{ backgroundColor: '#FFFFFF', padding: '18px 20px', borderRadius: 14, border: '1px solid #BAE6FD' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#0369A1', textTransform: 'uppercase' }}>Operations Managers</div>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#0284C7', marginTop: 4 }}>{opsTeam}</div>
          <div style={{ fontSize: 12, color: '#0369A1', fontWeight: 600, marginTop: 6 }}>Dispatch & Merchant Ops</div>
        </div>

        <div style={{ backgroundColor: '#FFFFFF', padding: '18px 20px', borderRadius: 14, border: '1px solid #BAE6FD' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#0369A1', textTransform: 'uppercase' }}>Finance & Support</div>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#0284C7', marginTop: 4 }}>{supportFinance}</div>
          <div style={{ fontSize: 12, color: '#0369A1', fontWeight: 600, marginTop: 6 }}>Payouts & Support Desk</div>
        </div>
      </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18, gap: 16, flexWrap: 'wrap' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, flex: 1, flexWrap: 'wrap' }}>
            ...
            <select
              ...
              style={{ padding: '9px 12px', borderRadius: 10, border: '1px solid #BAE6FD', fontSize: 13, fontWeight: 600, color: '#0C4A6E', outline: 'none' }}
            >
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            <thead>
              <tr style={{ backgroundColor: '#E0F2FE', borderBottom: '2px solid #BAE6FD', textAlign: 'left' }}>
                <th style={{ padding: '10px 12px', color: '#0C4A6E', fontWeight: 700 }}>Staff Member</th>
                <th style={{ padding: '10px 12px', color: '#0C4A6E', fontWeight: 700 }}>Contact Info</th>
                <th style={{ padding: '10px 12px', color: '#0C4A6E', fontWeight: 700 }}>Role Privilege</th>
                <th style={{ padding: '10px 12px', color: '#0C4A6E', fontWeight: 700 }}>Department</th>
                <th style={{ padding: '10px 12px', color: '#0C4A6E', fontWeight: 700 }}>Status</th>
                <th style={{ padding: '10px 12px', color: '#0C4A6E', fontWeight: 700 }}>Last Active</th>
                <th style={{ padding: '10px 12px', color: '#0C4A6E', fontWeight: 700 }}>Actions</th>
              </tr>
            </thead>
            <tbody>
              {filteredUsers.length === 0 ? (
                <tr>
                  <td colSpan={7} style={{ textAlign: 'center', padding: '32px', color: '#0369A1', fontWeight: 600 }}>
                ...
                filteredUsers.map((user) => {
                  ...
                  return (
                    <tr key={user.id} style={{ borderBottom: '1px solid #BAE6FD' }}>
                      <td style={{ padding: '12px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                          ...
                          <div>
                            <div style={{ fontWeight: 700, color: '#0C4A6E' }}>{user.fullName}</div>
                            <div style={{ fontSize: 11, color: '#0369A1' }}>ID: {user.id}</div>
                          </div>
                        </div>
                      </td>

                      <td style={{ padding: '12px' }}>
                        <div style={{ color: '#0C4A6E', fontWeight: 600 }}>{user.email}</div>
                        <div style={{ fontSize: 11, color: '#0369A1' }}>{user.phone}</div>
                      </td>
                      ...
                      <td style={{ padding: '12px', color: '#0C4A6E', fontWeight: 600 }}>
                        {user.department}
                      </td>
                      ...
                      <td style={{ padding: '12px', fontSize: 12, color: '#0369A1' }}>
                        {user.lastActive}
                      </td>
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                style={{ width: '100%', padding: '9px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, color: '#0C4A6E', outline: 'none' }}
              />
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div>
                ...
                <select
                  ...
                  style={{ width: '100%', padding: '9px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, fontWeight: 600, color: '#0C4A6E', outline: 'none' }}
                >
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontSize: 12, fontWeight: 700, color: '#0C4A6E', display: 'block', marginBottom: 6 }}>
                Select Target Role Privilege
              </label>
              <select
                value={targetRole}
                onChange={(e) => setTargetRole(e.target.value as AdminRole)}
                style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1px solid #BAE6FD', fontSize: 13, fontWeight: 700, color: '#0C4A6E', outline: 'none' }}
              >
