...
export function LegalPage({ initialTab = 'TERMS' }: { initialTab?: LegalTab }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      {activeTab === 'TERMS' && (
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, border: '1px solid #BAE6FD', padding: 28, display: 'flex', flexDirection: 'column', gap: 20, boxShadow: '0 2px 8px rgba(2, 132, 199, 0.04)' }}>
          <h2 style={{ fontSize: 18, fontWeight: 800, color: '#0369A1', margin: 0 }}>
            Master Platform Terms & Conditions
          </h2>
          <div style={{ fontSize: 14, color: '#0369A1', lineHeight: 1.7, display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <h3 style={{ fontSize: 15, fontWeight: 700, color: '#0369A1', margin: 0 }}>1. Platform Operational Framework</h3>
            ...
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <h3 style={{ fontSize: 15, fontWeight: 700, color: '#0369A1', margin: 0 }}>2. Merchant Agreement & Hygiene Compliance</h3>
              <div style={{ color: '#0284C7' }}>
            ...
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <h3 style={{ fontSize: 15, fontWeight: 700, color: '#0369A1', margin: 0 }}>3. Delivery Partner Conduct & Payout Rights</h3>
              <div style={{ color: '#0284C7' }}>
            ...
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h3 style={{ fontSize: 15, fontWeight: 700, color: '#0369A1', margin: 0 }}>4. Data Protection & Privacy Governance</h3>
                <button
                  type="button"
      ...
      {activeTab === 'PRIVACY' && (
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, border: '1px solid #BAE6FD', padding: 28, display: 'flex', flexDirection: 'column', gap: 20, boxShadow: '0 2px 8px rgba(2, 132, 199, 0.04)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ fontSize: 15, fontWeight: 800, color: '#0369A1' }}>256-Bit SSL Encryption</div>
            ...
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ fontSize: 15, fontWeight: 800, color: '#0369A1' }}>Driver KYC Confidentiality</div>
              <div style={{ fontSize: 13, color: '#0284C7' }}>
      ...
      {activeTab === 'REFUND' && (
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, border: '1px solid #BAE6FD', padding: 28, display: 'flex', flexDirection: 'column', gap: 20, boxShadow: '0 2px 8px rgba(2, 132, 199, 0.04)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <strong style={{ color: '#0369A1' }}>Instant Wallet Refunds</strong>
              <div style={{ fontSize: 13, color: '#0284C7' }}>
            ...
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <strong style={{ color: '#0369A1' }}>Post-Preparation Cancellations</strong>
              <div style={{ fontSize: 13, color: '#0284C7' }}>
            ...
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <strong style={{ color: '#0369A1' }}>Missing or Damaged Items</strong>
              <div style={{ fontSize: 13, color: '#0284C7' }}>
      ...
      {activeTab === 'DELIVERY' && (
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, border: '1px solid #BAE6FD', padding: 28, display: 'flex', flexDirection: 'column', gap: 20, boxShadow: '0 2px 8px rgba(2, 132, 199, 0.04)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ fontWeight: 800, color: '#0369A1', fontSize: 14 }}>Service Radius Limits</div>
              <div style={{ fontSize: 13, color: '#0284C7' }}>
            ...
            <div style={{ backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ fontWeight: 800, color: '#0369A1', fontSize: 14 }}>On-Time SLA Guarantee</div>
              <div style={{ fontSize: 13, color: '#0284C7' }}>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: 14, border: '1px solid #BAE6FD', padding: 28, display: 'flex', flexDirection: 'column', gap: 20, boxShadow: '0 2px 8px rgba(2, 132, 199, 0.04)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ fontWeight: 800, color: '#0369A1', fontSize: 14 }}>Essential System Cookies</div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ fontWeight: 800, color: '#0369A1', fontSize: 14 }}>Analytics & Performance Cookies</div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, backgroundColor: '#F0F9FF', padding: 18, borderRadius: 10, border: '1px solid #BAE6FD' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ fontWeight: 800, color: '#0369A1', fontSize: 14 }}>Marketing & Promotional Cookies</div>
