...
export function DarkstoreSettingsPage() {
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      ...
      <div style={{ backgroundColor: '#FFFFFF', borderRadius: 12, padding: 24, border: '1px solid #BAE6FD', boxShadow: '0 1px 3px rgba(2, 132, 199, 0.05)', display: 'flex', flexDirection: 'column', gap: 20 }}>
        <div>
          <label style={{ display: 'block', fontSize: 13, fontWeight: 700, color: '#0C4A6E', marginBottom: 6 }}>
            Assigned Workstation Terminal ID:
          </label>
          <input type="text" value="TERM-IND-01 (Packing Station #1)" disabled style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid #BAE6FD', backgroundColor: '#F0F9FF', color: '#0C4A6E', fontSize: 13 }} />
        </div>
        ...
        <div>
          ...
          <div style={{ fontSize: 13, color: '#0284C7', fontWeight: 800 }}>
