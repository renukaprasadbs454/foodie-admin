      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        {dispatchOrders.map((o) => (
          <div
            key={o.id}
            style={{
              backgroundColor: o.status === 'DISPATCHED' ? '#F0F9FF' : '#FFFFFF',
              borderRadius: 12,
              padding: 20,
          ...
          >
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <span style={{ fontSize: 18, fontWeight: 900, color: '#0369A1' }}>{o.orderNumber}</span>
                <span style={{ fontSize: 11, fontWeight: 800, backgroundColor: '#F0F9FF', color: '#0369A1', border: '1px solid #BAE6FD', padding: '2px 8px', borderRadius: 4 }}>
                  {o.priority} PRIORITY
                </span>
              ...
              <div style={{ fontSize: 12, color: '#0284C7', marginTop: 4 }}>
                ...
                <strong style={{ color: '#0284C7' }}>{o.pickupStatus}</strong>
              </div>
            </div>
            ...
            <div>
              {o.status !== 'DISPATCHED' ? (
                ...
                <div style={{ fontSize: 13, fontWeight: 800, color: '#0369A1', backgroundColor: '#F0F9FF', border: '1px solid #BAE6FD', padding: '8px 16px', borderRadius: 8 }}>
                   DISPATCHED AT GATE
                </div>
              )}
            </div>
