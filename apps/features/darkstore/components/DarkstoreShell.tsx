    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: '#FFFFFF', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <button
            ...
            style={{
              ...
              color: isOpenStatus ? '#0369A1' : '#E0F2FE',
              ...
              alignItems: 'center',
              gap: 6,
              boxShadow: isOpenStatus ? '0 2px 6px rgba(0,0,0,0.1)' : 'none',
            }}
          >
            <span
              style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', flex: 1 }}>
        ...
        >
          ...
          <div style={{ padding: 12, backgroundColor: 'rgba(255,255,255,0.12)', borderRadius: 10, border: '1px solid rgba(255,255,255,0.25)', marginTop: 20 }}>
