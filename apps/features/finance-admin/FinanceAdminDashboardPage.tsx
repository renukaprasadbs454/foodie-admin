    ...
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
        <div style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, border: '1px solid #BAE6FD', boxShadow: '0 2px 8px rgba(14, 165, 233, 0.08)' }}>
          ...
          <div style={{ fontSize: 24, fontWeight: 900, color: '#0369A1', marginTop: 4 }}>₹0.00</div>
        </div>

        <div style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, border: '1px solid #BAE6FD', boxShadow: '0 2px 8px rgba(14, 165, 233, 0.08)' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#0284C7', textTransform: 'uppercase' }}>PENDING PAYOUTS</div>
          <div style={{ fontSize: 24, fontWeight: 900, color: '#0284C7', marginTop: 4 }}>0 Batches</div>
        </div>

        <div style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, border: '1px solid #BAE6FD', boxShadow: '0 2px 8px rgba(14, 165, 233, 0.08)' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#0284C7', textTransform: 'uppercase' }}>HIGH-RISK APPROVALS</div>
          <div style={{ fontSize: 24, fontWeight: 900, color: '#0369A1', marginTop: 4 }}>0 Requests</div>
        </div>

        <div style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, border: '1px solid #BAE6FD', boxShadow: '0 2px 8px rgba(14, 165, 233, 0.08)' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#0284C7', textTransform: 'uppercase' }}>RECONCILIATION SLA</div>
          <div style={{ fontSize: 24, fontWeight: 900, color: '#0284C7', marginTop: 4 }}>100%</div>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
        ...
        >
          <div style={{ fontSize: 28, marginBottom: 8 }}></div>
          <div style={{ fontSize: 16, fontWeight: 800, color: '#0369A1' }}>Customer Payment Transactions</div>
          <p style={{ fontSize: 12, color: '#0284C7', margin: '4px 0 0' }}>View Razorpay & Cashfree payment attempts, initiate refunds, and inspect gateway logs.</p>
        </Link>
        ...
        >
          ...
          <p style={{ fontSize: 12, color: '#0284C7', margin: '4px 0 0' }}>Dual-authorization workflow for merchant payout releases above risk threshold.</p>
        </Link>
      </div>
    </div>
  );
