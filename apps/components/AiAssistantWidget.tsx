          ...
          >
            {messages.map((m) => (
              <div
                ...
                style={{
                  ...
                  backgroundImage: m.sender === 'user' ? 'linear-gradient(135deg, #0284C7, #0369A1)' : 'none',
                  color: m.sender === 'user' ? '#FFFFFF' : '#0C4A6E',
                  padding: '12px 14px',
              ...
              >
                ...
                {m.metrics && (
                  ...
                  >
                    {m.metrics.map((met) => (
                      ...
                      >
                        <div style={{ fontSize: 10, color: '#0369A1' }}>{met.label}</div>
                ...
                <div
                  style={{
                    fontSize: 10,
                    color: m.sender === 'user' ? '#BAE6FD' : '#0369A1',
                    marginTop: 6,
                    textAlign: 'right',
                  }}
                >
            ...
            {isTyping && (
              ...
              >
                ...
                <span className="pulse-live" style={{ width: 6, height: 6, backgroundColor: '#0284C7', borderRadius: '50%' }} />
              </div>
            )}
